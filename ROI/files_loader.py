...
class File_Loader:
    ...
    def load_paths(self):
        ...
        for i in range(1, self.number_of_files + 1):
            ...
            output_images.append(strg)


            # print(strg)
        #

        return input_image_path_list, rois_path_list, annotations_path_list, output_images
    ...
    def load_rois(self, input_path):
        ...
        for i in input_path:
            rois.append(cv2.cvtColor(cv2.imread(i), cv2.COLOR_BGR2GRAY))
